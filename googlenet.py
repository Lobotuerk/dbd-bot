...
def create_googlenet(width, height, frame_count, lr, output=9, model_name = 'otherception.model', device = 'gpu', num = '0', weights_path=None):
    ...
    loss3_classifier = Dense(output, name='loss3/classifier', kernel_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
